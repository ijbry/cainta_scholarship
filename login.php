...
<head>
    ...
    <title>Staff Login | Cainta Scholarship Program</title>
...
<div class="login-wrapper">
    <div class="login-card">
        <div class="login-header">
            <h4><i class="bi bi-person-badge me-2"></i>Staff Login</h4>
            <p>Cainta Scholarship Program — Municipality of Cainta, Rizal</p>
        </div>
        ...
        <form action="login_process.php" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <button type="button" class="eye-btn" onclick="togglePassword('staff-password', this)">
                        <i class="bi bi-eye"></i>
                    </button>
                </div>
            </div>
